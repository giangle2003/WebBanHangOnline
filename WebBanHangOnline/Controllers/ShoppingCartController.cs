    ...
    public class ShoppingCartController : Controller
    {
        ...
        public ActionResult Partial_Item_Cart()
        {
            ...
            if (cart != null && cart.Items.Any())
            {
                ...
                decimal tongTien = cart.Items.Sum(item => item.TotalPrice);

                // Nếu tổng tiền đơn hàng lớn hơn hoặc bằng giới hạn miễn phí, thì phí ship là 0
                if (tongTien >= gioiHanMiễnPhí)
                {
                    phiShip = 0;
                }
        ...
        public ActionResult CheckOut(OrderViewModel req)
        {
            ...
            if (ModelState.IsValid)
            {
                ...
                if (cart != null)
                {
                    ...
                    // Thêm phiShip từ Partial_Item_Cart
                    decimal phiShip = 25000; // Phí vận chuyển mặc định
                    decimal gioiHanMiễnPhí = 599000; // Giới hạn miễn phí vận chuyển
                    decimal tongTien = cart.Items.Sum(item => item.TotalPrice);
                    ...
                    order.ShippingFee = phiShip; // Gán phiShip vào đơn hàng
                    ...
                    contentCustomer = contentCustomer.Replace("{{PhiShip}}", WebBanHangOnline.Common.Common.FormatNumber(phiShip, 0));
                    ...
                    contentAdmin = contentAdmin.Replace("{{NgayDat}}", DateTime.Now.ToString("dd/MM/yyyy - HH:mm:ss"));
