    ...
    public class SettingSystemController : Controller
    {
        ...
        public ActionResult AddSetting(SettingSystemViewModel req)
        {
            ...
            if (checkTitle == null)
            {
                ...
                set.SettingValues = req.SettingTitle;
                db.SystemSettings.Add(set);
            }
            else
            {
                checkTitle.SettingValues = req.SettingTitle;
            ...
            if (checkLogo == null)
            {
                ...
                set.SettingValues = req.SettingLogo;
                db.SystemSettings.Add(set);
            }
            else
            {
                checkLogo.SettingValues = req.SettingLogo;
            ...
            if (email == null)
            {
                ...
                set.SettingValues = req.SettingEmail;
                db.SystemSettings.Add(set);
            }
            else
            {
                email.SettingValues = req.SettingEmail;
            ...
            if (Hotline == null)
            {
                ...
                set.SettingValues = req.SettingHotline;
                db.SystemSettings.Add(set);
            }
            else
            {
                Hotline.SettingValues = req.SettingHotline;
            ...
            if (TitleSeo == null)
            {
                ...
                set.SettingValues = req.SettingTitleSeo;
                db.SystemSettings.Add(set);
            }
            else
            {
                TitleSeo.SettingValues = req.SettingTitleSeo;
            ...
            if (DessSeo == null)
            {
                ...
                set.SettingValues = req.SettingDesSeo;
                db.SystemSettings.Add(set);
            }
            else
            {
                DessSeo.SettingValues = req.SettingDesSeo;
            ...
            if (KeySeo == null)
            {
                ...
                set.SettingValues = req.SettingKeySeo;
                db.SystemSettings.Add(set);
            }
            else
            {
                KeySeo.SettingValues = req.SettingKeySeo;
